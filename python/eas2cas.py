...
"""Return CAS given EAS and Pressure Altitude"""

import airspeed
import argparse

parser = argparse.ArgumentParser(description='Return CAS for a given EAS and pressure altitude')
...
print(airspeed.eas2cas(args.EAS, args.HP, speed_units=args.speed_units, alt_units=args.alt_units))