...
"""Return EAS given Mach and Pressure Altitude"""
...
CAS=airspeed.mach_alt2cas(args.M, args.HP, speed_units=args.speed_units, alt_units=args.alt_units)
print(airspeed.cas2eas(CAS, args.HP, speed_units=args.speed_units, alt_units=args.alt_units))