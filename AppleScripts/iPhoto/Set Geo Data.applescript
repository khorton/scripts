...
tell application "iPhoto"
	...
	try
		...
		set locationName to text returned of (display dialog "Location: " default answer "" buttons {"Continue"} default button "Continue")
		set city to text returned of (display dialog "City: " default answer "Northville" buttons {"Continue"} default button "Continue")
		set state to text returned of (display dialog "State: " default answer "Michigan" buttons {"Continue"} default button "Continue")
		set countryName to text returned of (display dialog "Country Name: " default answer "USA" buttons {"Continue"} default button "Continue")
		set countryCode to text returned of (display dialog "Country Code: " default answer "USA" buttons {"Continue"} default button "Continue")
		set |latitude| to text returned of (display dialog "Latitude: " default answer "42,25,35.76" buttons {"Continue"} default button "Continue")
		set northSouth to text returned of (display dialog "North/South: " default answer "N" buttons {"Continue"} default button "Continue")
		set |longitude| to text returned of (display dialog "Longitude: " default answer "83,29,35.16" buttons {"Continue"} default button "Continue")
